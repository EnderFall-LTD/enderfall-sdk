...
/** NeoForge 1.21.4 codec-backed portable positional recipe. */
final class NeoForgeWorkbenchRecipe implements Recipe<NeoForgeWorkbenchInput> {
    ...
    @Override
    public boolean matches(NeoForgeWorkbenchInput input, Level level) {
    ...
    @Override public RecipeSerializer<? extends Recipe<NeoForgeWorkbenchInput>> getSerializer() {
        return binding.serializer().get();
    }
    @Override public RecipeType<? extends Recipe<NeoForgeWorkbenchInput>> getType() { return binding.type().get(); }
    ...
    static RecipeSerializer<NeoForgeWorkbenchRecipe> serializer(NeoForgeRecipeBinding binding) {
        return new RecipeSerializer<>() {
            ...
            public StreamCodec<RegistryFriendlyByteBuf, NeoForgeWorkbenchRecipe> streamCodec() {
