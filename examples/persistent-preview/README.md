...
the server-held selection. Each row also exercises a native item-stack icon/count and a
portable hover description generated for the active Minecraft/loader target. The deliberately disabled
