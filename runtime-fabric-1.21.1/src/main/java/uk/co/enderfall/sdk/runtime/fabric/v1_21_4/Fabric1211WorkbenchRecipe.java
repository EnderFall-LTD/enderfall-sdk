...
/** Minecraft 1.21.1 replacement for Fabric's portable positional recipe. */
final class FabricWorkbenchRecipe implements Recipe<FabricWorkbenchInput> {
    ...
    @Override public RecipeSerializer<?> getSerializer() { return binding.serializer(); }
    @Override public RecipeType<?> getType() { return binding.type(); }
    ...
    static RecipeSerializer<FabricWorkbenchRecipe> serializer(java.util.function.Supplier<FabricRecipeBinding> binding) {
        return new RecipeSerializer<>() {
            ...
            @Override public StreamCodec<RegistryFriendlyByteBuf, FabricWorkbenchRecipe> streamCodec() {
